...
def send_email():
    ...
    smtp_server = 'smtp.office365.com'  # Hotmail için SMTP sunucusu
    smtp_port = 587  # SMTP sunucusu portu
    username = 'mahmutbagl58@hotmail.com'  # E-posta adresiniz
    password = 'Mahmut580+'  # E-posta hesabınızın şifresi

    # E-posta içeriği bilgileri
    from_email = 'mahmutbagl58@hotmail.com'
    to_email = 'mahmutbagl58@hotmail.com'
    subject = 'iyi günler'
    body = 'Bugün ki işlemleriniz sonucu tarafınıza mail gönderilmiştir.'
    ...
    try:
        ...
        server.starttls()  # TLS kullanarak bağlantıyı güvenli hale getirme
        ...
        messagebox.showinfo("Bildirim", "E-posta başarıyla gönderildi!")
...
def ask_send_email():
    answer = messagebox.askquestion("E-posta Gönderimi", "E-posta göndermek istiyor musunuz?")
    if answer == 'yes':
        send_email()
    elif answer == 'no':
        print("E-posta gönderme işlemi iptal edildi.")

# Ana pencere oluşturma
root = tk.Tk()
root.withdraw()  # Ana pencereyi gizleme

ask_send_email()  # E-posta göndermek isteyip istemediğini sorma
...
ui.btnCikis.clicked.connect(ask_send_email)    
